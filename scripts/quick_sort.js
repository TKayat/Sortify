...
function quick_partition (start, end)
{
    ...
    div_update(divs[start],div_sizes[start],"rgb(24, 190, 255)");//Color update
        ...
        for(var j =start + 1; j <= end ; j++ )
        {
            ...
            if (div_sizes[ j ] < piv)
            {
                ...
                div_update(divs[i],div_sizes[i],"#9BA4B5");//Height update
                div_update(divs[j],div_sizes[j],"#9BA4B5");//Height update
